...
-------------------------------------------------------------------------------
--
-- File        : U:\PREP\PREP_Modernization\Firmware_Backups\Aldec_Backups\One_Phase_Designs\AGP_2017_11_16_NIMPlus_jw121_320MHz_1Phase_Accel_Sync\NIMPlus\NIMPlus\compile\acc_sync.vhd
-- Generated   : 11/16/17 15:39:34
-- From        : U:\PREP\PREP_Modernization\Firmware_Backups\Aldec_Backups\One_Phase_Designs\AGP_2017_11_16_NIMPlus_jw121_320MHz_1Phase_Accel_Sync\NIMPlus\NIMPlus\src\acc_sync.asf
...
begin
	...
	case Sreg0 is
		when S3 =>
			...
			next_release_p <= '0';
		when S1 =>
			if (clk_13_25) = '1' or (clk_26_5 = '1') then
				NextState_Sreg0 <= S1;
				next_release_p <= '0';
			elsif (clk_13_25) = '0' and (clk_26_5 = '0') then
				NextState_Sreg0 <= S2;
				next_release_p <= '0';
			end if;
		when S2 =>
