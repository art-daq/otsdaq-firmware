...
begin
	...
	-- enter your statements here --
			p1:	process(wd_in0, wd_in1, wd_in2, wd_in3, wd_in4, wd_in5, s_addr, rst_p)
		begin
			if rst_p = '1' then
				...
				case s_addr is
						when "00" =>
							b_fifo_out(63 downto 32) <= wd_in1(31 downto 0);
						...
						when "10" =>
							b_fifo_out(63 downto 32) <= wd_in5(31 downto 0);
							b_fifo_out(31 downto 0) <= wd_in4(31 downto 0);
