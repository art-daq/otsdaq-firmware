...
-------------------------------------------------------------------------------
--
-- File        : C:\AGP_2018_05_02_NIMPlus_T_C_RJ45\NIMPlus\NIMPlus\compile\load_controller_v_ps.vhd
-- Generated   : 05/02/18 14:15:02
-- From        : C:\AGP_2018_05_02_NIMPlus_T_C_RJ45\NIMPlus\NIMPlus\src\load_controller_v_ps.asf
...
entity load_controller_v_ps is 
	port (
		clk: in STD_LOGIC;
...
end load_controller_v_ps;

architecture load_controller_v_ps_arch of load_controller_v_ps is
...
signal int_load_cmd_out_ps, next_load_cmd_out_ps: STD_LOGIC_VECTOR (3 downto 0);
...
------------------------------------
Sreg0_NextState: process (disable_ops, inhib_in, int_inhib_out, int_load_cmd_out, int_load_cmd_out_ps, int_release_out, load_cmd_in, load_cmd_reg, ps_en, release_in, sig_in, wr_cmd, Sreg0)
begin
	NextState_Sreg0 <= Sreg0;
	-- Set default values for outputs and signals
	next_load_cmd_reg <= load_cmd_reg;
	next_load_cmd_out <= int_load_cmd_out;
	next_load_cmd_out_ps <= int_load_cmd_out_ps;
	...
	case Sreg0 is
		...
		when idle =>
			if disable_ops = '1' then
				...
				next_load_cmd_out_ps <= load_cmd_reg;
				next_inhib_out <= '1';
				next_release_out <= '0';
			end if;
		when inhbtd =>
...
load_cmd_out_ps <= int_load_cmd_out_ps;
inhib_out <= int_inhib_out;
release_out <= int_release_out;

end load_controller_v_ps_arch;
