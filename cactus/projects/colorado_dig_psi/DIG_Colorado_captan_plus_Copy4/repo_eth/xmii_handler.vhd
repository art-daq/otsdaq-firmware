...
architecture arch of MII_100_1000_handler is	   
		...
		signal rx_data_handled2 : std_logic_vector(7 downto 0);				  
		signal rx_dv_handled2 : std_logic;				  
		signal rx_er_handled2 : std_logic;
begin				  	  
	...
	begin
		if rising_edge(clk) then
			rx_data_handled2 <=	 	rx_data;
			rx_dv_handled2 	<=		rx_dv;										  
			rx_er_handled2 	<= 	 	rx_er;	
			
			rx_data_handled <=	 	rx_data_handled2;
			rx_dv_handled 	<=		rx_dv_handled2;										  
			rx_er_handled 	<= 	 	rx_er_handled2;	  
