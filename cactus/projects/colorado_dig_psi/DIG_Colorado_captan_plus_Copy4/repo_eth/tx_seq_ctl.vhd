				...
				case Sreg0 is
					...
					when S5 =>
						if byte_count = 0 and qw_count = 0 then
							...
							Sreg0 <= S5;
							tx_data <= data_fifo_rd_data_reg(63 downto 56); 		--RAR for old format data_fifo_rd_data_reg(7 downto 0);
							...
							-- shift next byte into position
								data_fifo_rd_data_reg <= data_fifo_rd_data_reg(55 downto 0) & x"00"; 	--RAR for old format x"00" & data_fifo_rd_data_reg(63 downto 8);
							end if;
						end if;
					when trgrd =>
