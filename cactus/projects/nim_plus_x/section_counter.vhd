...
-------------------------------------------------------------------------------
--
-- File        : U:\PREP\PREP_Modernization\Firmware_Backups\Aldec_Backups\One_Phase_Designs\AGP_2017_11_16_NIMPlus_jw121_320MHz_1Phase_Accel_Sync\NIMPlus\NIMPlus\compile\section_counter.vhd
-- Generated   : 11/20/17 12:16:05
-- From        : U:\PREP\PREP_Modernization\Firmware_Backups\Aldec_Backups\One_Phase_Designs\AGP_2017_11_16_NIMPlus_jw121_320MHz_1Phase_Accel_Sync\NIMPlus\NIMPlus\src\section_counter.asf
...
constant max_sec: STD_LOGIC_VECTOR (5 downto 0) := "000101";
constant u_8: STD_LOGIC_VECTOR (5 downto 0) := "000001";
constant z_8: STD_LOGIC_VECTOR (5 downto 0) := "000000";
...
signal next_sec_reg: STD_LOGIC_VECTOR (5 downto 0);
	...
	case Sreg0 is
		when S11 =>
			if sec_cnt = max_sec then
				NextState_Sreg0 <= S10;
				next_sec_en <= sec_in(0);
				next_sec_cnt <= z_8;
			elsif sec_cnt < max_sec then
				NextState_Sreg0 <= S11;
				next_sec_en <= sec_reg(0);
				next_sec_reg(4 downto 0) <= sec_reg(5 downto 1);
				next_sec_reg(5) <= '0';
				next_sec_cnt <= sec_cnt + u_8;
			end if;
		when S9 =>
			if release_p = '0' then
				NextState_Sreg0 <= S9;
