...
signal int_st_out, next_st_out: STD_LOGIC_VECTOR (1 downto 0);
...
------------------------------------
Sreg0_NextState: process (disable_ops, inhib_in, int_inhib_out, int_load_cmd_out, int_release_out, int_st_out, load_cmd_in, load_cmd_reg, release_in, sig_in, wr_cmd, Sreg0)
begin
