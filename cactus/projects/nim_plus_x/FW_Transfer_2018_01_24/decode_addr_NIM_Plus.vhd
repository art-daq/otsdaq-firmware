...
-------------------------------------------------------------------------------
--
-- File        : c:\NIM_Plus\AGP_2016\NIMPlus\NIMPlus\src\decode_addr_NIM_Plus.vhd
...
--{entity {decode_addr_NIM_Plus} architecture {decode_addr_NIM_Plus}}

library IEEE;
use IEEE.STD_LOGIC_1164.all;

entity decode_addr_NIM_Plus is
	 port(
		 wr_en : in STD_LOGIC;
		 addr : in STD_LOGIC_VECTOR(31 downto 0);
		 blk_wr_en : out STD_LOGIC_VECTOR(7 downto 0)
	     );
end decode_addr_NIM_Plus;

--}} End of automatically maintained section

architecture decode_addr_NIM_Plus of decode_addr_NIM_Plus is
