...
parser.add_argument('-b','--board',default='captan_plus_x',
...
#comment out flash lines when "--flash" flag not used

if not args.flash:
    
    os.system("sed -i s/.\*--FLASH/--deleted\ since\ flash\ interface\ excluded/g " + dest + "/TOP_LEVEL.vhd")
