			...
			if rden = '0' then
				...
				case addr(16 downto 0) is
						...
						when "00000000000000010" =>
							read_data_out(31 downto 0) <= dlr_o;
							
						when "00000000000000011" =>
							read_data_out(31 downto 0) <= 	z_16 & z_16;
						...
						when "00000000000000101" =>
							read_data_out <= ver_o;	 -- Version number previously unused
...
-- Define channels							
						when "00000000100000010" =>  -- channel 1
							read_data_out(31 downto 0) <= dlr_1;
						...
						when "00000001000000010" =>  -- channel 2
							read_data_out(31 downto 0) <= dlr_2;
						...
						when "00000001100000010" =>  -- channel 3
							read_data_out(31 downto 0) <= dlr_3;
						...
						when "00000010000000010" =>  -- channel 4
							read_data_out(31 downto 0) <= dlr_4;
