...
package params_package is	
	...
	constant ETH_INTERFACE_VERSION: std_logic_vector(15 downto 0) := x"AACB"; -- use all letters, e.g. "AABF"  
	constant delay_term: natural := 0; --x"000A" --x"07D0";

	-- DO NOT TOUCH IP ADDRESS LINE BELOW.. Managed by setup and install script!
	constant ETH_CONTROLLER_DEFAULT_ADDR: std_logic_vector(7 downto 0) := std_logic_vector(to_unsigned(108,8)); -- must be 1 to 254 inclusive		
