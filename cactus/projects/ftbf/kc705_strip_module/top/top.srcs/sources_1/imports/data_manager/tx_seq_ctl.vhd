...
--signal tx_data_reg_old: STD_LOGIC_VECTOR (31 downto 0);
--signal tx_data_alert: STD_LOGIC;


--    attribute mark_debug : string;
----    attribute mark_debug of Sreg0 : signal is "true";
--    attribute mark_debug of data_info_fifo_empty : signal is "true";
--        attribute mark_debug of info_fifo_rden_sig : signal is "true";
--        attribute mark_debug of user_trigger : signal is "true";
--            attribute mark_debug of data_fifo_rd_data : signal is "true";
--            attribute mark_debug of user_tx_enable_out : signal is "true";
--                attribute mark_debug of qw_count : signal is "true";
--                            attribute mark_debug of tx_data_reg_old : signal is "true";
--            attribute mark_debug of tx_data_alert : signal is "true";
--       attribute mark_debug of data_fifo_rden_sig : signal is "true";
...
--							    tx_data_reg_old <= data_fifo_rd_data(31 downto 0);
--							    if(qw_count > 1 and tx_data_reg_old = data_fifo_rd_data(31 downto 0)) then
--							         tx_data_alert <= '1';
--							    end if;
