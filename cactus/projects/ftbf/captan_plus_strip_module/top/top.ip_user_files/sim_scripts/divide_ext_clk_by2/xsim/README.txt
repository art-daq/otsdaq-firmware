...
#
# Generated by export_simulation on Tue Jan 25 13:37:03 CST 2022
#
################################################################################
...
'-reset_run' switch to the './divide_ext_clk_by2.sh' script.

./divide_ext_clk_by2.sh -reset_run
...
./divide_ext_clk_by2.sh -noclean_files

For more information on the script, please type './divide_ext_clk_by2.sh -help'.
