...
create_clock -name BCOCLK -period 128.000 [get_pins strip_imp/stripclk_imp/dcm_bco_div_inst/O]
create_clock -name BCOCLK_FAST_BY2 -period 64.000 [get_pins divide_ext_clk_by2_inst/ext_clk_by2]
...
set_false_path -from [get_clocks [list BCOCLK BCOCLK_FAST_BY2 BCOCLK_FAST USER_CLOCK]] -to [get_clocks [list PHY_RXCLK   CLK5MHZ   CLK15NS    MCLK_A_strips_mclk_mmcm    MCLK_MULT3_strips_mclk_mmcm]]
set_false_path -from [get_clocks [list PHY_RXCLK   CLK5MHZ   CLK15NS    MCLK_A_strips_mclk_mmcm    MCLK_MULT3_strips_mclk_mmcm]]  -to [get_clocks [list BCOCLK BCOCLK_FAST_BY2 BCOCLK_FAST USER_CLOCK]]
...
set_false_path  -from [get_pins strip_imp/stripclk_imp/strips_mclk_gen/inst/mmcm_adv_inst/CLKOUT2] -to [get_clocks PHY_RXCLK]
