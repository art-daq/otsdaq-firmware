...
architecture BEHAVIORAL of data_manager is	  
   ...
   signal rx_fifo_preemptive_reset              : std_logic := '0';
   signal comm_dec_reset                        : std_logic := '0';
...
begin
	...
	user_tx_dest_mac   <= 	tx_data_dest_mac when tx_seq_ctl_sel = '1'	else
 	...
 	TX_DATA_FIFO : entity work.xilinx_fifo			  					 	--SCRIPT COMMENT OUT                        
      ...
      port map (clk=>MASTER_CLK,										--SCRIPT COMMENT OUT   
                ...
                rst=>comm_dec_reset,											--SCRIPT COMMENT OUT   
	...
	tx_ctrl_fifo_reset_sig <= comm_dec_reset or comm_dec_tx_fifo_reset or reset;	 
	...
	begin
		...
		rx_fifo_reset_sig <= rx_fifo_preemptive_reset or rx_fifo_reset or rx_fifo_watchdog_reset or reset;
	    comm_dec_reset <= rx_fifo_preemptive_reset or reset;
...
--   		             full=>open);
   ...
   GEC_RX_CTRL : entity work.rx_ctl
      port map (
                ...
                reset=>reset,			
                rx_fifo_preemptive_reset=>rx_fifo_preemptive_reset,			
