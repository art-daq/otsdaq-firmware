...
#for bitslip signal from FSM to serdes bitslip
set_max_delay  -datapath_only 24.000  -from [get_cells * -hierarchical -filter {IS_PRIMITIVE == true && (NAME =~ strip_imp/*serdes*/BITSLIP*)}] -to [get_clocks PHY_RXCLK]
