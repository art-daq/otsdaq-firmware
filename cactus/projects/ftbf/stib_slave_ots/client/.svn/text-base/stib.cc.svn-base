...
// 
  ...
  while ( i != s.end() ) {
    ...
    hs = *i++;
    if ( i == s.end() || i->Channel() != hs.Channel() || i->ChipId() != hs.ChipId() ) {
      hot = 1;
      cout << "Channel " << hs.Channel() << " ChipId " << hs.ChipId() << " mask = " << hex
           << setw(8) << setfill('0') << mask[0] << " "
           << setw(8) << setfill('0') << mask[1] << " "
           << setw(8) << setfill('0') << mask[2] << " "
           << setw(8) << setfill('0') << mask[3] << dec << endl;
