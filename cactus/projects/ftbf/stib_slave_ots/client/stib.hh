...
const unsigned int STRIP_DAQ_PARAM = 0xc4000098;
...
const unsigned int VIPIC_CSR = 0xc9000000;
const unsigned int VIPIC_CLOCK = 0xc9000004;
const unsigned int VIPIC_TS_COUNTER = 0xc9000040;
const unsigned int VIPIC_TS_COUNTER_LOW = 0xc9000040;
const unsigned int VIPIC_TS_COUNTER_HIGH = 0xc9000044;
const unsigned int VIPIC_WSET_BASE = 0xc9001000;
const unsigned int VIPIC_RSET_BASE = 0xc9001200;
const unsigned int VIPIC_WRESET_BASE = 0xc9001400;
const unsigned int VIPIC_RRESET_BASE = 0xc9001600;
...
public:
  Strip() : _word(-1) {}
  Strip(int chan, int strip) { _word = (chan << 16) | strip; }
  struct lt {
    bool operator()(const Strip &a, const Strip &b) const {
      return a._word < b._word;
    }
  };
  int Channel() const { return _word >> 16; }
  int StripNumber() const { return _word & 0x7f; }
  int ChipId() const { return ((_word >> 7) & 0x07) + 9; }
};

typedef std::set<Strip, Strip::lt> StripSet;
