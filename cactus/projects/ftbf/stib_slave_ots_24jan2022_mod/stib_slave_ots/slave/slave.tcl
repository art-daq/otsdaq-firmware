# 
# Project automation script for slave 
# 
# Created for ISE version 14.6
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source slave.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "../stib/add8.xco"
   xfile add "../stib/arp.vhd"
   xfile add "../stib/arprep.vhd"
   xfile add "../stib/arpreq.vhd"
   xfile add "../stib/arptab.vhd"
   xfile add "../stib/arptab_dpram.xco"
   xfile add "../stib/cksum.vhd"
   xfile add "../stib/clock.vhd"
   xfile add "../stib/clock_interface.vhd"
   xfile add "../stib/core.xco"
   xfile add "../stib/crc32.vhd"
   xfile add "../stib/ethernet.vhd"
   xfile add "../stib/fb.xco"
   xfile add "../stib/gbe.vhd"
   xfile add "../stib/gbe_interface.vhd"
   xfile add "../stib/icmp.vhd"
   xfile add "../stib/icmprep.vhd"
   xfile add "../stib/iobus.vhd"
   xfile add "../stib/iobus_interface.vhd"
   xfile add "../stib/ip.vhd"
   xfile add "../stib/ipbuf.vhd"
   xfile add "../stib/ipheader.vhd"
   xfile add "../stib/sb.xco"
   xfile add "../stib/sendpkt.vhd"
   xfile add "../stib/streampkt.vhd"
   xfile add "../stib/tlkfifo.xco"
   xfile add "../stib/tlkserdes.vhd"
   xfile add "../stib/tlkserdes_interface.vhd"
   xfile add "../stib/txether.vhd"
   xfile add "../stib/udp.vhd"
   xfile add "../strip/bcocounter.xco"
   xfile add "../strip/chip_fifo.xco"
   xfile add "../strip/chipserdes.vhd"
   xfile add "../strip/fastbcocounter.vhd"
   xfile add "../strip/packetfifo.xco"
   xfile add "../strip/streamipbuf.xco"
   xfile add "../strip/strip_interface.vhd"
   xfile add "../strip/stripana.vhd"
   xfile add "../strip/stripclk.vhd"
   xfile add "../strip/stripdac.vhd"
   xfile add "../strip/stripdacspi.vhd"
   xfile add "../strip/stripfifo.vhd"
   xfile add "../strip/stripreset.vhd"
   xfile add "../strip/stripsc.vhd"
   xfile add "../strip/stripstream.vhd"
   xfile add "../strip/striptbm.vhd"
   xfile add "../strip/trigbuf.xco"
   xfile add "../strip/trigcounter.xco"
   xfile add "../strip/trigprim.vhd"
   xfile add "../strip/trigproc.vhd"
   xfile add "stib.ucf"
   xfile add "stib_par.ucf"
   xfile add "top.vhd"
   xfile add "trigpattern.vhd"
   puts ""
...
proc create_libraries {} {
   ...
   lib_vhdl new "stib"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/icmp.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/icmprep.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/ethernet.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/clock.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/clock_interface.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/ip.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/ipbuf.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/arpreq.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/tlkserdes_interface.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/txether.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/ipheader.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/arp.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/gbe.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/gbe_interface.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/udp.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/tlkserdes.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/cksum.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/crc32.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/sendpkt.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/streampkt.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/iobus.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/iobus_interface.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/arprep.vhd"
      lib_vhdl add_file "stib" "/home/cmstestbeam/stib_June2014/stib/arptab.vhd"
   lib_vhdl new "strip"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/stripana.vhd"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/stripclk.vhd"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/stripstream.vhd"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/striptbm.vhd"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/fastbcocounter.vhd"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/stripdac.vhd"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/stripdacspi.vhd"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/trigprim.vhd"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/trigproc.vhd"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/chipserdes.vhd"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/strip_interface.vhd"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/stripfifo.vhd"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/stripreset.vhd"
      lib_vhdl add_file "strip" "/home/cmstestbeam/stib_June2014/strip/stripsc.vhd"
...
proc set_process_props {} {
   ...
   project set "Last Applied Strategy" "Performance without IOB Packing;/opt/Xilinx/14.6/ISE_DS/ISE/virtex4/data/virtex4_performance_without_iobpacking.xds"
   ...
   project set "Project Description" "This is the design for the STIB slave which only
reads out the strip sensors."
   ...
   project set "User Browsed Strategy Files" "/opt/Xilinx/14.6/ISE_DS/ISE/virtex4/data/virtex4_performance_without_iobpacking.xds"
   ...
   project set "Other Bitgen Command Line Options" "-bd \"./workspace/monitor/Debug/monitor.elf\" tag core" -process "Generate Programming File"
   ...
   project set "Other Ngdbuild Command Line Options" "-bm \"../stib/core.bmm\"" -process "Translate"
   ...
   project set "Work Directory" "/home/cmstestbeam/stib_June2014/slave/xst" -process "Synthesize - XST"
