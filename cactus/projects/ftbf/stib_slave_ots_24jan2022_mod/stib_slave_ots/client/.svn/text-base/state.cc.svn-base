...
int main(int argc,char **argv) {
  ...
  cout << "  strip CSR = 0x" << hex << setfill('0') << setw(8) << strip_csr << dec << endl;
  ...
  int nword = 16*(ipkt+1);
  cout << "    streaming packet size = " << nword << " words (" << nword*4 << " bytes)" << endl;
  cout << "    clock source : ";
  ...
  cout << "  stream status = 0x" << hex << setfill('0') << setw(8) << stream_status << dec << endl;
  ...
  cout << "   state word = 0x" << setfill('0') << hex << setw(2) << (stream_status>>24) << dec << endl;
  cout << endl;

  cout << "  streampkt CSR = 0x" << hex << setfill('0') << setw(8) << streampkt_csr << dec << endl;
