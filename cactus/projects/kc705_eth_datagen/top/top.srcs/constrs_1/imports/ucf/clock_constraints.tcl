...
set_false_path -from [get_clocks PHY_RXCLK] -to [get_clocks [list CLK5MHZ   CLK15NS  USER_CLOCK]]

set_false_path -from [get_clocks USER_CLOCK] -to [get_clocks [list CLK5MHZ   CLK15NS  PHY_RXCLK]]
