...
-------------------------------------------------------------------------------
--
-- File        : c:\NIM_Plus\AGP_2016\NIMPlus\NIMPlus\compile\sig_gen_prog.vhd
-- Generated   : 03/31/17 14:33:53
-- From        : c:\NIM_Plus\AGP_2016\NIMPlus\NIMPlus\src\sig_gen_prog.asf
...
signal p_count_r: STD_LOGIC_VECTOR (31 downto 0);
...
signal next_p_count_r: STD_LOGIC_VECTOR (31 downto 0);
...
begin
	...
	case Sreg0 is
		...
		when S7 =>
			if p_count_r = p_count and 
				p_count /= z_32 then
				NextState_Sreg0 <= S8;
				next_p_out <= '0';
			elsif (p_count_r < p_count and p_count /= z_32)
				or p_count = z_32 then
				NextState_Sreg0 <= S2;
				next_p_hi_r <= z_32;
				next_p_lo_r <= z_32;
			end if;
