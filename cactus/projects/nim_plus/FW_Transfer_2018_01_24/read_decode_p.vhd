	...
	begin
			...
			--elsif rden = '1' then -- and
				...
				case addr(7 downto 0) is
						when "00000000" =>
							read_data_out(63 downto 0) <= rd_0(63 downto 0);		 
						when "00000001" =>
							read_data_out(63 downto 0) <= rd_1(63 downto 0);
						when "00000010" =>
							read_data_out(63 downto 0) <= rd_2(63 downto 0);   
						when "00000011" =>
							read_data_out(63 downto 0) <= rd_3(63 downto 0);
						when "00000100" =>
							read_data_out(63 downto 0) <= rd_4(63 downto 0);	
						when "00000101" =>
							read_data_out(63 downto 0) <= rd_5(63 downto 0);
						when "00000110" =>
							read_data_out(63 downto 0) <= rd_6(63 downto 0);
						when "00000111" =>
							read_data_out(63 downto 0) <= rd_7(63 downto 0);   	 -- Channels 0 - 7
						
						when "00001000" =>
							read_data_out(63 downto 0) <= rd_8(63 downto 0);		 
						when "00001001" =>
							read_data_out(63 downto 0) <= rd_9(63 downto 0);
						when "00001010" =>
							read_data_out(63 downto 0) <= rd_10(63 downto 0);   
						when "00001011" =>
							read_data_out(63 downto 0) <= rd_11(63 downto 0);
						when "00001100" =>
							read_data_out(63 downto 0) <= rd_12(63 downto 0);	
						when "00001101" =>
							read_data_out(63 downto 0) <= rd_13(63 downto 0);
						when "00001110" =>
							read_data_out(63 downto 0) <= rd_14(63 downto 0);
						when "00001111" =>
							read_data_out(63 downto 0) <= rd_15(63 downto 0);		   		-- Channels 8 - 15

						when "00010000" =>
							read_data_out(63 downto 0) <= rd_16(63 downto 0);		 
						when "00010001" =>
							read_data_out(63 downto 0) <= rd_17(63 downto 0);
						when "00010010" =>
							read_data_out(63 downto 0) <= rd_18(63 downto 0);   
						when "00010011" =>
							read_data_out(63 downto 0) <= rd_19(63 downto 0);
						when "00010100" =>
							read_data_out(63 downto 0) <= rd_20(63 downto 0);	
						when "00010101" =>
							read_data_out(63 downto 0) <= rd_21(63 downto 0);
						when "00010110" =>
							read_data_out(63 downto 0) <= rd_22(63 downto 0);
						when "00010111" =>
							read_data_out(63 downto 0) <= rd_23(63 downto 0);   		-- Channels 16 - 23
						
						when "00011000" =>
							read_data_out(63 downto 0) <= rd_24(63 downto 0);		 
						when "00011001" =>
							read_data_out(63 downto 0) <= rd_25(63 downto 0);
						when "00011010" =>
							read_data_out(63 downto 0) <= rd_26(63 downto 0);   
						when "00011011" =>
							read_data_out(63 downto 0) <= rd_27(63 downto 0);
						when "00011100" =>
							read_data_out(63 downto 0) <= rd_28(63 downto 0);	
						when "00011101" =>
							read_data_out(63 downto 0) <= rd_29(63 downto 0);
						when "00011110" =>
							read_data_out(63 downto 0) <= rd_30(63 downto 0);
						when "00011111" =>
							read_data_out(63 downto 0) <= rd_31(63 downto 0);		-- Channels 24 - 31					
						
						
						
						when others =>
								read_data_out <= z_16 & z_16 & z_16 & z_16;	 -- High impedance on output
				end case;
			--end if;		 
		end	process p1;
