...
set_max_delay 32.00 -to [get_cells * -hierarchical -filter {IS_PRIMITIVE == true && (NAME =~ NIM_BLOCK/U416/*)}]
set_max_delay 32.00 -to [get_cells * -hierarchical -filter {IS_PRIMITIVE == true && (NAME =~ NIM_BLOCK/U420/*)}]
set_max_delay 32.00 -to [get_cells * -hierarchical -filter {IS_PRIMITIVE == true && (NAME =~ NIM_BLOCK/U424/*)}]
set_max_delay 32.00 -to [get_cells * -hierarchical -filter {IS_PRIMITIVE == true && (NAME =~ NIM_BLOCK/U425/*)}]
...
set_false_path -from [get_clocks clk_out_internal13_clk_wiz_internalClocks] -to [get_clks [list CLK_bmx_320 PHY_RXCLK]]
set_false_path -from [get_clocks clk_out_internal26_clk_wiz_internalClocks] -to [get_clks [list CLK_bmx_320 PHY_RXCLK]]
