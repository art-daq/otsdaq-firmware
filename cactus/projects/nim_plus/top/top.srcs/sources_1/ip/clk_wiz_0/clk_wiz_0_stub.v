...
module clk_wiz_0(MASTER_CLK, clkout160, reset, locked)
/* synthesis syn_black_box black_box_pad_pin="MASTER_CLK,clkout160,reset,locked" */;
  input MASTER_CLK;
  output clkout160;
  input reset;
  output locked;
