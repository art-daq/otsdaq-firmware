...
architecture BEHAVIORAL of data_manager is	  
   ...
   signal tx_ctrl_info_fifo_full				: std_logic;
    ...
    attribute mark_debug of tx_ctrl_fifo_rden : signal is "true";
    attribute mark_debug of tx_ctrl_fifo_read_enable : signal is "true";    
    attribute mark_debug of tx_data_fifo_rden : signal is "true";   
    attribute mark_debug of tx_data_fifo_read_enable : signal is "true";   
    attribute mark_debug of tx_seq_ctl_sel : signal is "true";   
    attribute mark_debug of user_tx_trigger : signal is "true";   
