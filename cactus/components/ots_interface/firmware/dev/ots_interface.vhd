...
entity ots_interface is
   port ( 								
          ...
          continuous_clk      	: in    std_logic; -- for generating reset signal (while PHY and MASTER_CLK may be down)		
...
architecture BEHAVIORAL of ots_interface is	   
...
begin										 
   ...
   burst_traffic_controller_blk : entity work.burst_traffic_controller
	...
	-------- end instatiate ots blocks section -------------
