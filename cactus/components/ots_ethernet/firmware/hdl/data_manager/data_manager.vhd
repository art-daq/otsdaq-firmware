...
--erased  generate watchdog reset, rx_fifo_watchdog_reset, for rx fifos (to get out of a jam)
...
--erased  potential problem so count down
...
--erased  reset for last 5 counts
